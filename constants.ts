import type { UpgradeConfig, GeneralUpgradeKey, Encounter, ConsumableItem } from './types';

export const GAME_HEIGHT = 800; // Defines the viewport aspect ratio
export const GAME_GRID_HEIGHT = 1000; // Defines the actual world height for perspective
export const GAME_WIDTH = 500;
export const GAME_GRID_X_OFFSET = -25; // Horizontal offset for the entire grid for centering adjustments.
export const GAME_HEIGHT_BUFFER = 250; // Extra space at the bottom for effects to finish
export const EFFECTS_CANVAS_TOP_BUFFER = 200; // Extra space at the top for projectiles to fly off-screen
export const OFFSCREEN_BUFFER = 100; // Extra buffer for entities to be considered offscreen

// Visual constants for the background grid
export const GRID_CELL_HEIGHT = 64;
export const GRID_COLOR = 'rgba(0, 255, 255, 0.1)';
export const GRID_SCROLL_SPEED = GRID_CELL_HEIGHT / 400; // 0.16 px/ms
...
const detectMobile = (): boolean => {
  ...
  // Check if running in a native Capacitor container. This is the most reliable check.
  const Capacitor = (window as any).Capacitor;
  if (Capacitor?.isNativePlatform && Capacitor.isNativePlatform()) {
    return true;
  }
  // Fallback for mobile browsers: check for touch points.
  // `maxTouchPoints > 0` is a good indicator of a touch-capable device.
  // Also check that the screen isn't huge, to avoid matching touch-screen laptops.
  const hasTouch = navigator.maxTouchPoints > 0;
  const isSmallScreen = window.screen.width < 1024; // Common breakpoint for tablets vs laptops.
  return hasTouch && isSmallScreen;
};

// ✅ MOBILE OPTIMIZATION: Cache user agent check (never changes during session)
...
export const PLAYER_HITBOX_MAIN_RADIUS = 18;
...
export const PLAYER_TOTAL_VISUAL_WIDTH = 104; // Total width of ship + drones for clamping
...
export const PLAYER_SPRITE_WIDTH = GAME_WIDTH * 0.08;
export const PLAYER_SPRITE_HEIGHT = GAME_GRID_HEIGHT * 0.10;
...
// The base color for projectiles. The ship's glow defaults to cyan separately.
...
export const PROJECTILE_COLOR_ALPHA_L3 = '#e0f2fe'; // sky-100, a bright white-blue
export const PROJECTILE_COLOR_CORROSIVE = '#84cc16'; // lime-500
export const PLAYER_PROJECTILE_DAMAGE_MIN = 100;
export const PLAYER_PROJECTILE_DAMAGE_MAX = 150;
export const PLAYER_PROJECTILE_DAMAGE_RANGE = PLAYER_PROJECTILE_DAMAGE_MAX - PLAYER_PROJECTILE_DAMAGE_MIN + 1; // ✅ OPTIMIZATION: Pre-compute for calculateDamage


export const ENEMY_SPEED = 150; // pixels per second
export const ENEMY_HEIGHT = 40;
export const ENEMY_HEIGHT_HALF = ENEMY_HEIGHT / 2; // ✅ OPTIMIZATION: Pre-compute to avoid repeated division
export const ENEMY_WIDTH = 64;
export const ENEMY_HITBOX_RADIUS = 25;
export const ENEMY_BASE_HEALTH = 100; // Standard enemies die in 1 hit on normal, multiple on hard.
export const MAX_ENEMIES_NORMAL = 18;
export const MAX_ENEMIES_HARD = 30;

export const ENEMY_PROJECTILE_SPEED = 400; // pixels per second
export const ENEMY_PROJECTILE_SPEED_VARIATION = 0.4; // projectiles can be 20% faster or slower
...
export const ENEMY_PROJECTILE_DUPLICATION_ANGLE = 15; // degrees
...
export const CURRENCY_STREAK_BONUS_PER_LEVEL_HARD = 0.10; // 10% bonus per consecutive level in hard mode
...
export const PLAYER_SLOW_DURATION = 3000; // ms
export const PLAYER_MOVEMENT_SLOW_MULTIPLIER = 0.4; // 40% of normal speed
export const PLAYER_FIRERATE_SLOW_MULTIPLIER = 1.8; // 80% slower fire rate (180% of normal interval)
...
export const DODGER_DODGE_SPEED = 900; // pixels per second
export const DODGER_DODGE_COOLDOWN = 450; // ms
...
export const CONDUIT_SHIELD_BREAK_COOLDOWN = 5000; // Time before a target can be re-shielded after its conduit dies.
...
export const WEAVER_PAUSE_DURATION = 2600; // ms to pause and shoot
export const WEAVER_BEAM_INTERVAL = 1800; // ms between beams for a single weaver
export const WEAVER_BEAM_DURATION = 1000; // ms the beam stays on screen
export const WEAVER_BEAM_HITBOX_HEIGHT = 8; // pixels
export const WEAVER_SURGE_SPEED = 600; // pixels per second
...
export const ASTEROID_SIZES = {
  small: { health: 500, radius: 18, score: 250, currency: 50, partChance: 0.10, spawnWeight: 6 },
  medium: { health: 1500, radius: 30, score: 750, currency: 150, partChance: 0.30, spawnWeight: 3 },
  large: { health: 4000, radius: 48, score: 2000, currency: 400, partChance: 1.0, spawnWeight: 1 },
};
...
export const ASTEROID_FIELD_SURVIVAL_REWARD_CURRENCY = 7500;
export const ASTEROID_FIELD_SURVIVAL_REWARD_PARTS = 2;
export const ASTEROID_FIELD_SURVIVAL_REWARD_SCORE = 15000;
...
export const CRITICAL_HIT_DURATION = 250; // ms
...
export const SCREEN_SHAKE_MAGNITUDE_EXPLOSION = 2; // pixels
export const SCREEN_SHAKE_DURATION_BOSS_DEATH = 1500; // ms
export const SCREEN_SHAKE_MAGNITUDE_BOSS_DEATH = 4; // pixels
export const SCREEN_SHAKE_MAGNITUDE_BEAM = 1.5; // pixels
export const SCREEN_SHAKE_DURATION_BEAM = 100; // ms

// Screen flash on explosion
export const SCREEN_FLASH_DURATION = 200; // ms

// Background lightning effect
export const LIGHTNING_DURATION = 120; // ms
...
export const WARDEN_TOTAL_VISUAL_WIDTH = 180; // Warden width (150px) + 2 * cannon offset (15px each)
...
export const WARDEN_SPAWN_MINION_COUNT = 3;
...
export const PUNISHER_TOTAL_VISUAL_WIDTH = 234; // Punisher width (180px) + 2 * pod offset (27px each)
...
export const PUNISHER_LASER_HITBOX_WIDTH_RATIO = 0.6; // 60% of the lane width is the actual danger zone
...
export const PUNISHER_MINION_SCALING_ADD = 1; // +1 minion per encounter (was 2)
export const PUNISHER_MINION_SCALING_CAP = 10; // Max 10 base minions (was 8)
...
export const WARDEN_MINION_SCALING_ADD = 1; // +1 minion per encounter after the second fight (was 2)
export const WARDEN_MINION_SCALING_CAP = 8; // was 6
...
export const ALPHA_L3_PROJECTILE_SIZE_MULTIPLIER = 1.01;
export const ALPHA_L3_DAMAGE_MULTIPLIER = 1.2;
...
// Beta Hero Phase Shift (L3 Upgrade)
export const BETA_L3_PHASE_SHIFT_DISTANCE_THRESHOLD = GAME_WIDTH * 0.5; // 50% of game width
export const BETA_L3_PHASE_SHIFT_DURATION = 1500; // 1.5 seconds of invulnerability
export const BETA_L3_PHASE_SHIFT_COOLDOWN = 5000; // 5 seconds cooldown after effect ends

// Gamma Hero Perk
export const GAMMA_SHIELD_CHANCE_BONUS = 0.25; // +25% shield chance on level up (total 40%)
export const GAMMA_EMP_L2_CHANCE = 0.45;
export const GAMMA_EMP_L2_RANGE = 180;
export const GAMMA_EMP_L2_COOLDOWN = 1000;
export const GAMMA_EMP_L3_CHANCE = 0.65;
export const GAMMA_EMP_L3_RANGE = 280;
...
export const CRYSTALITE_COST_REVIVE = 50;
export const CRYSTALITE_COST_FAST_RELOAD = 25;
export const CRYSTALITE_COST_RAPID_FIRE = 75;
export const CRYSTALITE_COST_SPEED_BOOST = 60;
...
// Rare Consumables
export const CORROSIVE_ROUNDS_SHOTS = 2500;
export const CORROSIVE_ROUNDS_IMPACT_MULTIPLIER = 1.1;
export const CORROSIVE_DAMAGE_PER_TICK = 50;
export const CORROSIVE_TOTAL_TICKS = 10; // 5 seconds total
export const CORROSIVE_TICK_INTERVAL = 500; // ms
...
export const HANGAR_GENERAL_UPGRADE_CONFIG: Record<GeneralUpgradeKey, UpgradeConfig[]> = {
    movement_speed_level: [
        ...
        { currency: 280000, parts: 70, time: 5400000, effect: 0.20 }, // L4: 90 min (TIER 2)
        { currency: 600000, parts: 150, time: 10800000, effect: 0.25 },// L5: 3h (TIER 2)
        { currency: 1250000, parts: 300, time: 32400000, effect: 0.30 },// L6: 9h (TIER 2)
    ],
    reload_speed_level: [
        ...
        { currency: 220000, parts: 65, time: 5400000, effect: 0.40 }, // L4: 90 min (TIER 2)
        { currency: 500000, parts: 140, time: 10800000, effect: 0.50 },// L5: 3h (TIER 2)
        { currency: 1100000, parts: 280, time: 32400000, effect: 0.60 },// L6: 9h (TIER 2)
    ],
    ammo_capacity_level: [
        ...
        { currency: 320000, parts: 90, time: 7200000, effect: 50 },  // L4: 120 min (TIER 2)
        { currency: 700000, parts: 180, time: 18000000, effect: 70 }, // L5: 5h (TIER 2)
        { currency: 1500000, parts: 350, time: 45000000, effect: 100 },// L6: 12.5h (TIER 2)
    ],
    trident_shot_level: [
...
export const TRAINING_TARGET_HIT_COOLDOWN = 80; // ms

// Random Encounters
export const ENCOUNTER_CHANCE_ON_LEVEL_UP = 0.15; // 15% chance for an encounter on level up.
    ...
    },
    {
        ...
        outcomes: [
            ...
            // --- Outcomes if player DOES NOT have a shield ---
            {
                ...
                result: { type: 'lose_random_items', title: "Sabotage!", text: "The thief jettisons an escape pod, taking some of your pre-flight consumables with them!" }
            },
            {
            ...
            { 
                ...
                outcomes: [
                    ...
                    },
                    {
                        probability: 0.2,
                        result: {
                            type: 'gain_rare_consumable',
                            cost: 5000,
                            rareConsumableType: 'corrosive',
                            rareConsumableShots: CORROSIVE_ROUNDS_SHOTS,
                            title: "Aftermarket Munitions",
                            text: "The trader offers a crate of illegal, aftermarket munitions. The corrosive warheads look unstable, but powerful."
                        }
                    },
                    {
                        probability: 0.1,
    ...
    },
    {
        ...
        choices: [
            ...
            },
            {
                ...
                outcomes: [{
                    probability: 1,
                    result: { type: 'nothing', title: 'Mission First', text: 'You inform the medic you can\'t help. They sigh and wish you luck on your own mission.' }
                }]
            }
        ]
    },
...
// ============================================================================
// IN-GAME CONSUMABLE NAMES
// ============================================================================
export const CONSUMABLE_NAMES: Record<ConsumableItem, string> = {
    revive: 'Revive Kit',
    fastReload: 'Adrenal Injector',
    rapidFire: 'Overdrive Core',
    speedBoost: 'Engine Coolant',
};

// ============================================================================
// IN-APP PURCHASE PRODUCT CONFIGURATION
// ============================================================================
// These product IDs must match exactly what's configured in:
// - Apple App Store Connect
// - Google Play Console

export const IAP_PRODUCTS = {
    CRYSTALITE_100: {
        id: 'com.galaxia.crystalite_100',
    ...
    CRYSTALITE_550: {
        id: 'com.galaxia.crystalite_550',
        name: 'Pile of Crystalite',
        amount: 550,
        price: '$4.99',
        color: 'cyan',
        iconSize: 'h-16 w-16',
    ...
    CRYSTALITE_1200: {
        id: 'com.galaxia.crystalite_1200',
        name: 'Chest of Crystalite',
        amount: 1200,
        price: '$9.99',
        color: 'yellow',
        iconSize: 'h-20 w-20',
    ...
    CRYSTALITE_2500: {
        id: 'com.galaxia.crystalite_2500',
        name: 'Crate of Crystalite',
        amount: 2500,
        price: '$19.99',
        color: 'yellow',
        iconSize: 'h-24 w-24',
    ...
    CRYSTALITE_7000: {
        id: 'com.galaxia.crystalite_7000',
        name: 'Vault of Crystalite',
        amount: 7000,
        price: '$49.99',
        color: 'purple',
        iconSize: 'h-28 w-28',
    ...
    CRYSTALITE_15000: {
        id: 'com.galaxia.crystalite_15000',
        name: 'Star-Tons of Crystalite',
        amount: 15000,
        price: '$99.99',
        color: 'purple',
        iconSize: 'h-32 w-32',
...
export const IAP_PRODUCT_IDS = Object.values(IAP_PRODUCTS).map(p => p.id);

// IAP Configuration
export const IAP_CONFIG = {
    // Purchase validation timeout (ms)
    VALIDATION_TIMEOUT: 30000,
    
    // Maximum retry attempts for failed purchases
    ...
    // Local storage keys
    STORAGE_KEYS: {
        PENDING_PURCHASES: 'galaxia_pending_purchases',
        PURCHASE_HISTORY: 'galaxia_purchase_history',
        LAST_RESTORE_ATTEMPT: 'galaxia_last_restore_attempt'
    }
} as const;

// ============================================================================
// COLLISION DETECTION CONSTANTS (Pre-calculated for performance)
// ============================================================================
export const SQUARED_PROJECTILE_ENEMY_RADIUS = (PROJECTILE_HITBOX_RADIUS + ENEMY_HITBOX_RADIUS) ** 2;
export const SQUARED_PROJECTILE_ASTEROID_SMALL_RADIUS = (PROJECTILE_HITBOX_RADIUS + ASTEROID_SIZES.small.radius) ** 2;
export const SQUARED_PROJECTILE_ASTEROID_MEDIUM_RADIUS = (PROJECTILE_HITBOX_RADIUS + ASTEROID_SIZES.medium.radius) ** 2;
export const SQUARED_PROJECTILE_ASTEROID_LARGE_RADIUS = (PROJECTILE_HITBOX_RADIUS + ASTEROID_SIZES.large.radius) ** 2;

export const SQUARED_ENEMY_PROJECTILE_PLAYER_MAIN_RADIUS = (ENEMY_PROJECTILE_HITBOX_RADIUS + PLAYER_HITBOX_MAIN_RADIUS) ** 2;
export const SQUARED_ENEMY_PROJECTILE_PLAYER_NOSE_RADIUS = (ENEMY_PROJECTILE_HITBOX_RADIUS + PLAYER_HITBOX_NOSE_RADIUS) ** 2;

export const SQUARED_POWERUP_PLAYER_MAIN_RADIUS = (POWERUP_HITBOX_RADIUS + PLAYER_HITBOX_MAIN_RADIUS) ** 2;
export const SQUARED_POWERUP_PLAYER_NOSE_RADIUS = (POWERUP_HITBOX_RADIUS + PLAYER_HITBOX_NOSE_RADIUS) ** 2;

export const SQUARED_PLAYER_MAIN_ENEMY_RADIUS = (PLAYER_HITBOX_MAIN_RADIUS + ENEMY_HITBOX_RADIUS) ** 2;
export const SQUARED_PLAYER_NOSE_ENEMY_RADIUS = (PLAYER_HITBOX_NOSE_RADIUS + ENEMY_HITBOX_RADIUS) ** 2;

export const SQUARED_PLAYER_MAIN_ASTEROID_SMALL_RADIUS = (PLAYER_HITBOX_MAIN_RADIUS + ASTEROID_SIZES.small.radius) ** 2;
export const SQUARED_PLAYER_NOSE_ASTEROID_SMALL_RADIUS = (PLAYER_HITBOX_NOSE_RADIUS + ASTEROID_SIZES.small.radius) ** 2;
export const SQUARED_PLAYER_MAIN_ASTEROID_MEDIUM_RADIUS = (PLAYER_HITBOX_MAIN_RADIUS + ASTEROID_SIZES.medium.radius) ** 2;
export const SQUARED_PLAYER_NOSE_ASTEROID_MEDIUM_RADIUS = (PLAYER_HITBOX_NOSE_RADIUS + ASTEROID_SIZES.medium.radius) ** 2;
export const SQUARED_PLAYER_MAIN_ASTEROID_LARGE_RADIUS = (PLAYER_HITBOX_MAIN_RADIUS + ASTEROID_SIZES.large.radius) ** 2;
export const SQUARED_PLAYER_NOSE_ASTEROID_LARGE_RADIUS = (PLAYER_HITBOX_NOSE_RADIUS + ASTEROID_SIZES.large.radius) ** 2;