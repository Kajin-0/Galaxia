...
export class ObjectPool<T> {
    ...
    /**
     * Iterates over currently pooled objects to warm up V8 hidden classes and JIT optimization.
     * This safely accesses the private pool array.
     */
    warmUp(callback: (item: T) => void) {
