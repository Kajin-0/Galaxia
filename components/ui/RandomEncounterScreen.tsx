...
export const RandomEncounterScreen: React.FC<RandomEncounterScreenProps> = ({ 
    encounter, onChoose, totalCurrency, currencyEarnedThisRun, ownedRevives, ownedFastReloads, ownedRapidFires, ownedSpeedBoosts 
}) => {
                ...
                <div className="flex flex-col items-center gap-4 w-full">
                    {encounter.isChoice ? (
                        encounter.choices?.map((choice, index) => {
                            ...
                            if (cost > 0 && (totalCurrency + currencyEarnedThisRun) < cost) {
                                isDisabled = true;
                            }
